...
Oznam o nahrávaní počuje zákazník a každý externý účastník (prepojenie, konzultácia alebo pridanie na číslo mimo tímu) skôr, než sa dostane do rozhovoru. Kolegovia z tímu — prepojenie, konzultácia, pridanie účastníka či dozor na prehliadačovom telefóne alebo osobnom mobile — oznam nepočujú: sú informovaní internou politikou a hovor sa im spojí hneď po prijatí. Záznam sa po ich pripojení obnovuje rovnako, ako keby oznam vypočuli.
