...
Samostatný Telnyx test musí overiť kanály, hranice segmentov a absenciu súkromných markerov. Pri úplnosti a globálnom časovaní sa nesmie zamieňať metadátový čas poskytovateľa so vzorkovo presným začiatkom WAV. Výsledky aktuálneho vydania a nevyriešené podmienky patria do release/UltraQA záznamu; tento návod sám nepotvrdzuje zapnutie produkcie.
