...
const data: DispatchData = {
  ...
  users: [], partnerDirectory: [], fleetProviderVehicles: [], commanderVehicles: [], source: "supabase",
};
Object.assign(window, { workspaceFixtureData: data });
createRoot(document.getElementById("root")!).render(<DispatchConsole layoutPreviewEnabled initialData={data} viewerOrganizationId="00000000-0000-4000-8000-000000000001" viewerProfileId="00000000-0000-4000-8000-000000000002" viewerRole="manager" viewerDisplayName="Test dispečer" appVersion="isolated-workspace" />);
