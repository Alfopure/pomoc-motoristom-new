...
export const ROUTE_AUTH_REGISTRY: Record<string, RouteAuthEntry> = {
  ...
  "telephony/config/business-hours": { class: "session", note: "GET member-level; PUT manager/admin (rola sa kontroluje v handleConfigWrite)." },
  "telephony/config/numbers": { class: "session", note: "GET member-level; PATCH manager/admin. Kúpa čísla cez Telnyx nie je súčasťou tejto fázy." },
  "telephony/config/pause-reasons": { class: "session", note: "GET member-level; PUT manager/admin." },
  "telephony/config/ring-groups": { class: "session", note: "GET member-level; PUT manager/admin (transakčná výmena cez motorist_replace_ring_plan)." },
  "telephony/config/ring-plans": { class: "session", note: "GET member-level; PUT manager/admin (transakčná výmena cez motorist_replace_ring_plan)." },
