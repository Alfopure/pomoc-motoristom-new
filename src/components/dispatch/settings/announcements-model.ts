...
export function sameAnnouncementConfig(left: AnnouncementConfig, right: AnnouncementConfig): boolean {
  ...
  if ((left.inboundStartAnnouncements !== false) !== (right.inboundStartAnnouncements !== false)) return false;
  if ((left.outboundStartAnnouncements === true) !== (right.outboundStartAnnouncements === true)) return false;
