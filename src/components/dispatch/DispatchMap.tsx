  ...
  if (!GoogleMap) {
    const loadingClassName =
      props.workspaceMode === "expanded"
        ? "flex h-full min-h-0 items-center justify-center rounded-md border border-zinc-200 bg-zinc-100 text-sm font-medium text-zinc-600"
        : "flex h-full min-h-0 items-center justify-center rounded-md border border-zinc-200 bg-zinc-100 text-sm font-medium text-zinc-600 lg:min-h-[420px]";
