...
export const ANNOUNCEMENT_DEFINITIONS = [
  ...
  { key: "holdStart", label: "Podržanie hovoru", description: "Krátke oznámenie pri podržaní zákazníka pred hudbou.", file: "holdStart.mp3", assetVersion: "v2", category: "waiting", runtimeStatus: "prepared" },
  ...
  { key: "resume", label: "Návrat k hovoru", description: "Voliteľné poďakovanie pred návratom operátora k hovoru.", file: "resume.mp3", assetVersion: "v2", category: "waiting", runtimeStatus: "prepared" },
  { key: "transferStart", label: "Začiatok prepájania", description: "Oznámenie pred prepájaním hovoru.", file: "transferStart.mp3", assetVersion: "v2", category: "handoff", runtimeStatus: "prepared" },
  ...
  { key: "consultStart", label: "Overenie ďalšieho postupu", description: "Vysvetlenie čakania počas overovania ďalšieho postupu.", file: "consultStart.mp3", assetVersion: "v2", category: "handoff", runtimeStatus: "prepared" },
  { key: "parkStart", label: "Čakanie na prevzatie", description: "Oznámenie, že hovor čaká na prevzatie kolegom.", file: "parkStart.mp3", assetVersion: "v2", category: "handoff", runtimeStatus: "prepared" },
  { key: "conferenceJoin", label: "Pripojenie účastníka", description: "Upozornenie pred pripojením ďalšieho účastníka.", file: "conferenceJoin.mp3", assetVersion: "v2", category: "handoff", runtimeStatus: "prepared" },
  { key: "conferenceLeave", label: "Odchod účastníka", description: "Voliteľné potvrdenie odchodu účastníka.", file: "conferenceLeave.mp3", assetVersion: "v2", category: "handoff", runtimeStatus: "prepared" },
  { key: "outboundIntro", label: "Úvod odchádzajúceho hovoru", description: "Predstavenie služby po prijatí odchádzajúceho hovoru.", file: "outboundIntro.mp3", assetVersion: "v2", category: "other", runtimeStatus: "prepared" },
  ...
  { key: "recordingNotice", label: "Upozornenie na nahrávanie", description: "Návrh oznámenia o nahrávaní a kontrole kvality.", file: "recordingNotice.mp3", assetVersion: "v2", category: "recording", runtimeStatus: "prepared" },
  { key: "recordingPaused", label: "Potvrdenie vypnutia nahrávania", description: "Oznámenie určené až po skutočnom vypnutí nahrávania.", file: "recordingPaused.mp3", assetVersion: "v2", category: "recording", runtimeStatus: "prepared" },
  { key: "recordingResumed", label: "Obnovenie nahrávania", description: "Oznámenie pred povoleným obnovením nahrávania.", file: "recordingResumed.mp3", assetVersion: "v2", category: "recording", runtimeStatus: "prepared" },
