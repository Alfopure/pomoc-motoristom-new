...
export const ANNOUNCEMENT_DEFINITIONS = [
  ...
  { key: "holdReminder", label: "Pripomenutie pri čakaní", description: "Poďakovanie počas dlhšieho čakania.", file: "holdReminder.mp3", assetVersion: "v4", category: "waiting", runtimeStatus: "prepared" },
  { key: "queueWaiting", label: "Čakáreň a spätné volanie", description: "Výzva zostať na linke alebo stlačiť 1 pre spätné volanie, potom minúta hudby. Opakuje sa počas čakania.", file: "queueWaiting.mp3", assetVersion: "v4", category: "waiting", runtimeStatus: "active" },
  ...
  { key: "afterHoursNoCallback", label: "Mimo hodín bez spätného volania", description: "Odkaz mimo otváracích hodín, ak spätné volanie nie je dostupné.", file: "afterHoursNoCallback.mp3", assetVersion: "v4", category: "other", runtimeStatus: "prepared" },
