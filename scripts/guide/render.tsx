...
import { guideChapters, GUIDE_CONTENT_VERSION, GUIDE_UPDATED_AT } from "../../src/content/guide/chapters";
...
export const knowledge = buildGuideKnowledge(guideChapters, screenshots, { version: GUIDE_CONTENT_VERSION, updatedAt: GUIDE_UPDATED_AT, sourceRevision: "5ae0d99" });
